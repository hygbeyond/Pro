...
void SVCall_Handler(void) ALIAS(IntDefaultHandler);
...
void KFLASH_IRQHandler (void) ALIAS(IntDefaultHandler);
...
unsigned long pulMainStack[STACK_SIZE];

/*
 * 增加了加密选项
 */
__attribute__ ((section(".crp")))
const unsigned long flash_crp =
#if EN_CRP == 1
0x12345678;
#elif EN_CRP == 2
0x87654321;
...
void (* const g_pfnVectors[])(void) = {
	...
	KFLASH_IRQHandler  ,  // ; 56: KFLASH SHELL
};
