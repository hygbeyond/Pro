...
${COMPILER}/%.o: %.c
	@if [ 'x${VERBOSE}' = x ];                            \
	 then                                                 \
	     ...
	     echo ${CC} -c ${ALL_FLAGS} ${CFLAGS} -D${COMPILER} -o ${@} ${<}; \
	 fi
	@${CC} -c ${ALL_FLAGS} ${CFLAGS} -D${COMPILER} -o ${@} ${<}  ${GENDEPFLAGS}
...
${COMPILER}/%.o: %.s
	@if [ 'x${VERBOSE}' = x ];                               \
	 then                                                    \
	     ...
	     echo ${CC} -c ${ALL_FLAGS} ${AFLAGS} -D${COMPILER} -o ${@} -c ${<}; \
	 fi
	@${CC} -c ${ALL_FLAGS}  ${AFLAGS} -D${COMPILER} -o ${@} -c ${<} ${GENDEPFLAGS} 
